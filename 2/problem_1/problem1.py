...
atoms.calc = Vasp(
    ...
    isif=3,  # Relax ions and cell shape/volume (2 = ions only; 3 = ions + cell)
...
initial_magmoms = [0.0] * len(atoms)  # Initial guess for magnetic moments
